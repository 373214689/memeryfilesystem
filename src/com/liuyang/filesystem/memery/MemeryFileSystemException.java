 ...
 * @since 1.7
 */
public class MemeryFileSystemException extends IOException {
	private static final long serialVersionUID = 2064031169243459907L;
     ...
     */
    public MemeryFileSystemException(String file) {
        super((String)null);
        this.file = file;
        this.other = null;
    }
     ...
     */
    public MemeryFileSystemException(String file, String other, String reason) {
        super(reason);
        this.file = file;
        this.other = other;
    }
